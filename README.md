...
- session.raster[i],window[0] have
  0 . O <span style="font-variant: small-caps;">iii</span> ~702.7 $\AA$  
  1 . O <span style="font-variant: small-caps;">iii</span> ~703.2 $\AA$
  2 . Mg <span style="font-variant: small-caps;">ix</span> ~706 $\AA$

- session.raster[i],window[1] have
  0 . S <span style="font-variant: small-caps;">iv</span> ~748 $\AA$
  1 . Mg <span style="font-variant: small-caps;">ix</span> ~749.5 $\AA$
  2 . S <span style="font-variant: small-caps;">iv</span> ~750 $\AA$ 
...
- session.raster[i],window[0] have
  ...
  1 . O <span style="font-variant: small-caps;">iii</span> ~703.2 $\AA$
  2 . Mg <span style="font-variant: small-caps;">ix</span> ~706 $\AA$
  3 . S <span style="font-variant: small-caps;">iv</span> ~748 $\AA$
  4 . Mg <span style="font-variant: small-caps;">ix</span> ~749.5 $\AA$
  5 . S <span style="font-variant: small-caps;">iv</span> ~750 $\AA$ 
and now we use 
