...
def despike(raw_data:np.ndarray,
    ...
    clipped_data =sigma_clip(trunc_data,size=clipping_med_size,high=clipping_sigma,low=clipping_sigma,iterations=clipping_iterations)
    data = raw_data.copy()
