...
import numpy as np
from astropy.visualization import ImageNormalize, AsymmetricPercentileInterval, SqrtStretch
...
def denoise_data(row_data,denoise_sigma):
    ...
    # denoising    
    denoised_3d_truncated = denoise(trunc_data, scaling_function =B3spline, weights = denoise_sigma, anscombe=True)
